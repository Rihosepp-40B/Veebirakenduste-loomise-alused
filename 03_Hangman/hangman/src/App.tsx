...
function App() {
  ...
  //kui olev pakkunud valesid tähti kuus korda , siis kaotad
  ...
  const addGuessedLetter = useCallback
    ((letter: string) => {
      //isLoser ja isWinner ja wastavalt sellele annab tulemuse 
      if (guessedLetters.includes(letter) || isLoser || isWinner)
        return
      //funktsioon on edasi antud setter'ile, võta praegune olek ja returni uus versioon või situatsioon
  ...
  return (
    <div
      style={{
        ...
        {/* kutseume esile erinevad komponendid */}
